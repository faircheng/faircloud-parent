...
public enum StatusCodeEnum implements StatusCode {
    ...
    A0110("A0110", "用户名校验失败"),
    A0111("A0111", "EntityAlreadyExists.AccountAlias"),
    A0112("A0112", "用户名包含敏感词"),
    A0113("A0113", "用户名包含特殊字符"),
    A0120("A0120", "密码校验失败"),
    A0121("A0121", "密码长度不够"),
    A0122("A0122", "密码强度不够"),
    A0123("A0123", "必须含有小写字母"),
    A0124("A0124", "必须含有大写字母"),
    A0125("A0125", "必须含有数字"),
    A0126("A0126", "必须含有特殊字符"),
    A0130("A0130", "校验码输入错误"),
    ...
    A0151("A0151", "InvalidParameter.MobilePhone.Format"),
    A0152("A0152", "地址格式校验失败"),
    A0153("A0153", "InvalidParameter.Email.Format"),
    A0200("A0200", "用户登录异常"),//二级宏观错误码
    A0201("A0201", "用户账户不存在"),
    A0202("A0202", "用户账户被冻结"),
    A0203("A0203", "用户账户已作废"),
    A0210("A0210", "用户密码错误"),
    ...
    A0242("A0242", "您已在另外一台设备登录，本次登录已下线！"),
