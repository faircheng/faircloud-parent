...
import com.faircloud.iam.password.infrastructure.persistence.converter.PasswordPolicyInfraConverter;
...
public class PasswordPolicyAdapter implements PasswordPolicyPersistence {
    ...
    public PasswordPolicyAggregate getPasswordPolicy(UserAggregate aggregate) {
        ...
        return PasswordPolicyInfraConverter.INSTANCE.to(passwordPolicy);
    }

    @Override
    public void save(PasswordPolicyAggregate aggregate) {
        passwordPolicyMapper.insertOrUpdate(PasswordPolicyInfraConverter.INSTANCE.to(aggregate));
    }
}
